          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-blog-post">
              ...
              <div class="blog-post-content">
                ...
                <h3>
                  <nuxt-link to="/blog-details"
                    >The Most Popular New top Business Apps</nuxt-link
                  >
                </h3>
                <p>
                ...
                <nuxt-link to="/blog-details" class="read-more-btn"
                  >Read More</nuxt-link
                >
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-blog-post">
              ...
              <div class="blog-post-content">
                ...
                <h3>
                  <nuxt-link to="/blog-details"
                    >The Best Marketing top use Management Tools</nuxt-link
                  >
                </h3>
                <p>
                  Lorem Ipsum is simply dummy text of the printing and
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-blog-post">
              ...
              <div class="blog-post-content">
                ...
                <h3>
                  <nuxt-link to="/blog-details"
                    >3 WooCommerce Plugins to Boost Sales</nuxt-link
                  >
                </h3>
                <p>
                  Lorem Ipsum is simply dummy text of the printing and
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-blog-post">
              ...
              <div class="blog-post-content">
                ...
                <h3>
                  <nuxt-link to="/blog-details"
                    >Top 21 Must-Read Blogs For Creative Agencies</nuxt-link
                  >
                </h3>
                <p>
                  Lorem Ipsum is simply dummy text of the printing and
