<template>
    <div class="home-slides-three bottom-carousel-dots owl-carousel owl-theme">
        <carousel
            :autoplay = true
        ...
        >
            <slide>
                <div class="main-banner item-bg19">
                    <div class="d-table">
            ...
            <slide>
                <div class="main-banner item-bg20">
                    <div class="d-table">
                        <div class="d-table-cell">
                            <div class="container">
                                <div class="main-banner-content white-color">
            ...
            <slide>
                <div class="main-banner item-bg21">
                    <div class="d-table">
                        <div class="d-table-cell">
                            <div class="container">
                                <div class="main-banner-content white-color">
            ...
            <slide>
                <div class="main-banner item-bg22">
                    <div class="d-table">
                        <div class="d-table-cell">
                            <div class="container">
                                <div class="main-banner-content white-color">
